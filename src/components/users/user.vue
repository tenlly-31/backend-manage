<template>
  <div class="scn-lists">
    ...
    >
      <!-- 添加表单数据 -->
      <el-form :model="changeForm" :rules="addFormRules" ref="changeFormRef" label-width="70px">
        <el-form-item label="用户名" prop="username">
...
export default {
  ...
  methods: {
    ...
    // 确定分配角色
    async saveRoleInfo() {
      if(!this.selected) return this.$Message.error("请选择要修改的角色")
